...
@section('content')
    ...
    <div class="main-content">
        <h2 align="center">Edit  {{ $statics->headline}}</h2>


        <form action="{{route('statics.update',['id' => $statics->id])}}" method="post" enctype="multipart/form-data">
            {{ csrf_field()}}
            <div class="form-body pal">
                <div class="form-group">
                    ...
                    <div class="col-md-9"><div class="input-icon right">
                            <input id="name" type="text" value="{{ $statics->headline}}"  name="headline" class="form-control"  required /></div>
                    </div></div>
                <div class="form-group">
                ...
                <div class="form-body pal">
                    ...
                    <div class="form-body pal">
                        <div class="form-group">
                            ...
                            <div class="col-md-9"><div class="input-icon right">
                                    <textarea id="" type="text" name="description" cols="30" rows="10" class="form-control"  required >{{$statics->description}}</textarea></div>
                            </div></div>
