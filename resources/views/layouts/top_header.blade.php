	...
	<header class="theme-main-header theme-header-two">
		<div class="top-header bg-color">
			<div class="container clearfix">
				...
				<p class="float-right call-us">Call us for any questions : <a href="tel:{{$setting->pnumber}}">{{$setting->pnumber}}</a></p>
			</div> <!-- /.container -->
		</div> <!-- /.top-header -->
			...
			<div class="container clearfix">
				...
				<ul class="our-address clearfix">
					...
					<li>
						...
						<p><a href="#">{{$setting->pnumber2}}</a> <br>Free call</p>
					</li>
				</ul>
			</div>
		</div> <!-- /.middle-header -->
...
<footer class="theme-footer-one">
		<div class="container">
			<div class="top-footer">
				<div class="logo"><a href="{{'/'}}"><img src="{{$setting->image}}" width="60px" height="60px" alt="logo"></a></div>
				<ul class="clearfix">
					<li>
...
<!-- Calendar js -->
<script type="text/javascript" src="{{asset('assets/vendor/monthly-master/js/monthly.js')}}"></script>
<!-- Time picker -->
<script type="text/javascript" src="{{asset('assets/vendor/time-picker/jquery.timepicker.min.js')}}"></script>
<!-- ui js -->
